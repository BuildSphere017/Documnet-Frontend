...
const capabilities = [
  {
    icon: Sparkles,
    title: "Answers, not just files",
    desc: "Ask in plain language and get replies cited to the exact page.",
  },
  {
    icon: ScanSearch,
    title: "Find it any way you have it",
    desc: "Search by meaning, keyword, or a screenshot of a filename.",
  },
  {
    icon: ShieldCheck,
    title: "Access you control",
    desc: "Per-category permissions with a complete audit trail.",
  },
]
  ...
  const onSubmit = async (values: FormValues) => {
    try {
      ...
      if (err?.response) {
        ...
        toast.error(
          "Can't reach the server. Check that the backend is running and VITE_API_URL is correct.",
        )
      }
    }
  }
        ...
        <div className="relative max-w-lg space-y-8">
          <div>
            ...
            <p className="mt-4 max-w-md text-[15px] leading-relaxed text-white/55">
              The document workspace for the MAKPHALT sales team — with
              grounded AI search, OCR, and answers you can trace back to the
              source.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className="h-11 border-border bg-white placeholder:text-muted-foreground/60 focus-visible:ring-primary/30"
                {...register("username")}
              />
            ...
            <Button
              ...
              className="group mt-2 h-11 w-full shadow-sm"
            >
              {isSubmitting ? (
